"""
Django settings for mongodb_blog project.
"""
import os
import sys
...
MIDDLEWARE = [
    ...
    'mongodb_blog.esi.middleware.ESIMiddleware',
]

ROOT_URLCONF = 'mongodb_blog.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mongodb_blog.utils.context_processors.global_vars',
            ],
        },
    },
]

WSGI_APPLICATION = 'mongodb_blog.wsgi.application'
...
if 'SENTRY_DSN' in env:
    ...
    # dokku config:set mongodb_blog SENTRY_ENVIRONMENT=staging
...
if env.get('BASIC_AUTH_ENABLED', 'false').lower().strip() == 'true':
    ...
    BASIC_AUTH_LOGIN = env.get('BASIC_AUTH_LOGIN', 'mongodb_blog')
    BASIC_AUTH_PASSWORD = env.get('BASIC_AUTH_PASSWORD', 'showmemongodb_blog')
...
WAGTAIL_SITE_NAME = "MongoDB Blog"
