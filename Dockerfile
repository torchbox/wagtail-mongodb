...
WORKDIR mongodb_blog/static_src
...
COPY ./mongodb_blog/static_src/package.json ./mongodb_blog/static_src/package-lock.json ./
RUN npm install
...
RUN useradd mongodb_blog
RUN chown -R mongodb_blog .
USER mongodb_blog

# Run the WSGI server. It reads GUNICORN_CMD_ARGS, PORT and WEB_CONCURRENCY
# environment variable hence we don't specify a lot options below.
CMD gunicorn mongodb_blog.wsgi:application
