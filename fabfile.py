...
PRODUCTION_APP_INSTANCE = 'mongodb_blog-production'

STAGING_APP_INSTANCE = 'mongodb_blog-staging'
STAGING_APP_DB_INSTANCE = 'mongodb_blog-staging-db'
STAGING_REMOTE = 'dokku@staging.torchbox.com'

DEV_APP_INSTANCE = 'mongodb_blog-dev'
DEV_APP_DB_INSTANCE = 'mongodb_blog-dev'
DEV_REMOTE = 'dokku@staging.torchbox.com'

LOCAL_MEDIA_FOLDER = '/vagrant/media'
LOCAL_DATABASE_NAME = 'mongodb_blog'
